    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="image" class="altura">
                ...
                <img src="../public/img/labpc.jpg" alt="Nossa comunidade de inscritos" height="980vh">
            </div>
     ...
     <div class="row">
                ...
                <div class="image">
                    <img src="../public/img/fiber-optic.jpg" alt="Roteador 6G" class="ft">
                </div>
...
<br><br><br><br><br>
            ...
            <div class="row">
                ...
                <div class="image">
                    <img src="../public/img/Sem-Título-1.png" alt="" class="ft">
                </div>
            ...
            <br><br><br><br><br>
                ...
                <div class="image">
                    <img src="../public/img/machine.jpg" alt="" class="ft">
                </div>
            ...
            <div class="row">
                ...
                <div class="image">
                    <img src="../public/img/coffeehous.jpg" alt="" class="ft">
                </div>
            ...
            <div class="row">
                ...
                <div class="image">
                    <img src="../public/img/receptionists.jpg" alt="" class="ft">
                </div>
            ...
            <div class="row">
                ...
                <div class="image">
                    <img src="../public/img/meeting.jpg" alt="" class="ft">
                </div>
