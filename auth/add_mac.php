...
if(isset($_POST['submit'])){
	...
	$result = mysqli_query($conn, "INSERT INTO machine(name, specifications, price) VALUES ('$name', '$specifications', '$price')");
}
?>
		...
		<form action="../auth/add_mac.php" method="POST" style="margin-bottom: 2rem;">
			<div class="cardHeader2">
				<h3>Maquina:</h3>
			</div>

			<label for="name" id="al">Nome da Maquina</label> <br>
			<input class="box1" type="text" name="name" id="name" placeholder="Nome da maquina">

			<label for="name" id="al">Especificacoes</label> <br>
			<input class="box1" type="text" name="specifications" id="name" placeholder="Especificacoes">

			<label for="name" id="al">Preco</label> <br>
			<input class="box1" type="number" name="price" id="name" placeholder="Preco">
